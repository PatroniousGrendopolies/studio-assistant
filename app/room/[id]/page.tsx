...
export default function ChatPage() {
  ...
  return (
    <div className="flex h-dvh flex-col bg-[#0a0a0a] text-white">
                ...
                <div
                  className={`max-w-[85%] rounded-2xl px-4 py-2.5 text-sm leading-relaxed whitespace-pre-wrap ${
                    isUser
                      ...
                      : isSafety
                        ? "border-2 border-amber-500/60 bg-amber-950/40 text-amber-100"
      ...
      {/* Symptom picker */}
      {showSymptoms && (
        <div className="shrink-0 border-t border-neutral-800 bg-neutral-900 px-4 py-4">
          <div className="mx-auto grid max-w-2xl grid-cols-2 gap-2">
            {SYMPTOM_CATEGORIES.map((cat) => (
              <button
                ...
                className="flex items-center gap-2.5 rounded-xl border border-neutral-700 bg-neutral-800 px-3 py-3 text-left text-sm text-neutral-200 transition-colors hover:border-neutral-500 hover:bg-neutral-700 active:bg-neutral-700"
              >
      ...
      <div className="shrink-0 border-t border-neutral-800 bg-neutral-900 px-4 py-3">
        <div className="mx-auto flex max-w-2xl items-center gap-2">
          <button
            ...
            className="shrink-0 rounded-full border border-neutral-700 p-2 text-neutral-400 transition-colors hover:border-neutral-500 hover:text-neutral-200"
          ...
          <form onSubmit={handleSubmit} className="flex flex-1 items-center gap-2">
            <input
              ...
              className="flex-1 rounded-full border border-neutral-700 bg-neutral-800 px-4 py-2.5 text-sm text-white placeholder-neutral-500 outline-none transition-colors focus:border-neutral-500"
              disabled={isStreaming}
            />
            <button
              type="submit"
              disabled={!inputValue.trim() || isStreaming}
              className="shrink-0 rounded-full bg-white p-2.5 text-black transition-opacity disabled:opacity-30"
            >
              <svg
                className="h-4 w-4"
                viewBox="0 0 24 24"
          ...
          {/* Mic button — placeholder for VoiceInput component */}
          <button
            type="button"
            className="shrink-0 rounded-full border border-neutral-700 p-2 text-neutral-400 transition-colors hover:border-neutral-500 hover:text-neutral-200"
            title="Voice input"
